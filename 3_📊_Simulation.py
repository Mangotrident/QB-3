...
if status == 'completed' and job_status.get('results'):
    ...
    with col3:
        if st.button("🧠 View Diagnostics", use_container_width=True):
            st.info("💡 Navigate to the 'Diagnostics' page in the sidebar for AI-powered insights!")
    ...
    st.info("💡 Navigate to the 'Upload' page in the sidebar to submit new data.")
...
if st.sidebar.button("🏠 Back to Home"):
    st.info("💡 Navigate to the 'Home' page in the sidebar.")
