...
with col2:
    ...
    **Navigate using the sidebar:**
    - 📤 **Upload Data**: Submit your omics files
    - 📊 **Simulation**: View analysis results  
    - 🧠 **Diagnostics**: AI-powered insights
    - 📜 **About**: Science & references
    """)
...
with st.expander("🔬 Try a Quick Simulation Demo"):
    ...
    **Ready to analyze your own data?** Use the Upload Data page in the sidebar!
    """)
